...
QVector<Users> Users::GetUserByNames(QString FirstName, QString LasName)
{
	QString l_QueryStr( "SELECT * FROM " + m_TABLENAME + " WHERE user_firstname = " + FirstName + " AND user_lastname = " + LasName + " ;");
...
void Users::BuildUserTagsMap()
{
	...
	int _id = l_Query.record().indexOf("_id");
